...
# Simple interpretations/poems (Sample)
POEMS = {
    "乾为天": "困龙得水。刚健中正，气势磅礴。宜积极进取，但防盈不可久。",
    "坤为地": "饿虎得食。柔顺宽厚，包容万物。宜静不宜动，厚德载物。",
    "天地否": "虎落平阳。上下不通，闭塞之象。此时不宜冒进，当守正避难。",
    "地天泰": "喜报三元。阴阳交感，万物通泰。大吉之兆，宜大展宏图。",
    # ... In a real app, I would add more, or use a general generator.
}
